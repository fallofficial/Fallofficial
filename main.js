...
ZoO.sendMessage("62895321491786@s.whatsapp.net", {text: `
...
if (ff.isGroup == false) {
if (ff.status == "offer") {
let sendcall = await ZoO.sendMessage(ff.from, {text: `What's You Callme?`, contextInfo: {mentionedJid: [ff.from], externalAdReply: {thumbnailUrl: "https://telegra.ph/file/4b74d33cc26cbb9bfd120.jpg", title: "｢ CALL DETECTED ｣", previewType: "PHOTO"}}}, {quoted: null})
